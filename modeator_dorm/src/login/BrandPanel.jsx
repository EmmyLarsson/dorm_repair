export default function BrandPanel() {
  return (
    <section
      ...
      "
      style={{
        // 👉 จุดที่จะเปลี่ยนเป็นรูปจริงในอนาคต: แก้ background ตรงนี้เป็น
        // background: `url(...) center/cover` ได้เลย (ตามคอมเมนต์ในเว็บเดิม)
        background:
          'linear-gradient(135deg, #0c2a8f 0%, #1a40c2 45%, #3b5bdb 100%)',
      }}
    >
      {/* ── Pattern ตกแต่งพื้นหลัง (เทียบเท่า .brand-pattern) ── */}
      <div
      ...
      {/* ── การ์ดข้อความหลัก (เทียบเท่า .brand-card) ── */}
